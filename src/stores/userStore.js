...
const useUserStore = defineStore("user", {
  ...
  getters: {
    ...
    getUserSpotifyAuthAccessToken(state) {
      return state.spotify_auth_access_token
    },
  ...
  actions: {
    ...
    async generateSpotifyUnAuthAccessToken() {
    ...
    async generateSpotifyAuthAccessToken() {
      console.log(" [ generateSpotifyAuthAccessToken ]: Authenticating User ")
      ...
      // Spotify's endpoint for requesting an access token
      ...
      const authUrl = `${spotifyAuthEndpoint}?${new URLSearchParams(params).toString()}`

      console.log(" [ generateSpotifyAuthAccessToken ]: authUrl :" + authUrl)
